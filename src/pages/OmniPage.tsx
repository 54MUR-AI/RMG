    ...
    <div className="min-h-screen bg-samurai-black">
      ...
      {!showReadme && (
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <h1 className="text-5xl font-black text-samurai-red mb-6 neon-text">OMNI</h1>
          <p className="text-xl text-white/80 mb-8">Optimized Multi-Model Networked Intelligence</p>
          <button
